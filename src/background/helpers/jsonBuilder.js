...
module.exports = {
    ...
    entitiesJson: async function() {
        ...
        const lastBosses = [{id:"951.0.0",floors_ids:["13.1"],xp:100},{id:"912.0.0",floors_ids:["8.4"]},{id:"274.0.0",floors_ids:["11.0","11.1"],xp:120},{id:"273.0.0",floors_ids:["11.0"],xp:80},{id:"102.1.0",floors_ids:["11.1"],xp:75},{id:"412.0.0",floors_ids:["12.0"],xp:200},{id:"406.0.0",floors_ids:["7.0", "7.1", "7.2"],xp:90}]
        ...
        const entitiesJson = convertEntitiesXml.entities.entity.map(entity => {
            ...
            if (!ignoreEntities.includes(entityId) && entity._attributes.baseHP && parseInt(entity._attributes.baseHP) > 0 && entity._attributes.collisionDamage && parseInt(entity._attributes.collisionDamage) > 0 || entity._attributes.boss === "1") {
                return {
                    ...
                    xp: lastBosses.findIndex(boss => boss.id === entityId) > -1 ? lastBosses.find(boss => boss.id === entityId).xp : 0
                }
            }
