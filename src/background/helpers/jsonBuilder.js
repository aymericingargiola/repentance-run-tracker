...
module.exports = {
    ...
    buildEntitiesJson: async function(xml) {
        ...
        const lastBosses = [{id:"951.0.0",floor_ids:["13.1"]},{id:"912.0.0",floor_ids:["8c"]},{id:"274.0.0",floor_ids:["11.0","11.1"]},{id:"273.0.0",floor_ids:["11.0"]},{id:"102.1.0",floor_ids:["11.1"]},{id:"412.0.0",floor_ids:["12.0"]}]
        ...
        const entitiesJson = convertEntitiesXml.entities.entity.map(entity => {
            ...
            if (!ignoreEntities.includes(entityId) && entity._attributes.baseHP && parseInt(entity._attributes.baseHP) > 0 && entity._attributes.collisionDamage && parseInt(entity._attributes.collisionDamage) > 0) {
                return {
                    ...
                    floor_ids: lastBosses.findIndex(boss => boss.id === entityId) > -1 ? lastBosses.find(boss => boss.id === entityId).floor_ids : null,
