...
module.exports = {
    ...
    entitiesJson: async function() {
        ...
        const lastBosses = [{id:"951.0.0",floors_ids:["13.1"]},{id:"912.0.0",floors_ids:["8.4"]},{id:"274.0.0",floors_ids:["11.0","11.1","12.0"]},{id:"273.0.0",floors_ids:["11.0","12.0"]},{id:"102.1.0",floors_ids:["11.1", "12.0"]},{id:"412.0.0",floors_ids:["12.0"]},{id:"406.0.0",floors_ids:["7.0", "7.1", "7.2"]}]
