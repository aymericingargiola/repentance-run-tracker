    ...
    <transition name="show">
        <div v-if="errors.length > 0" class="pop-up app-error">
            <div class="content">
                ...
                <p class="message">You can help debug this issue by uploading a zip file generated by the button under this error message, create a new issue <a href="https://github.com/aymericingargiola/repentance-run-tracker/issues/new?assignees=aymericingargiola&labels=bug&template=bug_report.md&title=" target="_blank">here</a> then attach the file. <br><br>The file will only contains logs and app datas.</p>
                <ul class="error-area">
